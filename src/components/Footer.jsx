    ...
    return (
        <>
            <footer className="footer">
                <div className="svg">
                    <NavLink className="insta" target='_blank' to='https://instagram.com'>
                    ...
                    <NavLink className="X" target='_blank' to='https://x.com'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" color="#000000"
                            fill="none">
                            <path
                    ...
                    <NavLink className="insta" target='_blank' to='https://facebook.com'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" color="#000000"
                            fill="none">
                    ...
                    <NavLink className="insta" target='_blank' to='https://linkedin.com'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" color="#000000"
                            fill="none">
                            <path
                    ...
                    <NavLink to='https://github.com/princeraval147/crazy-car'>

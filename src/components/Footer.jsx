        ...
        <>
            <footer className="footer">
                ...
                <div className="svg">
                    ...
                    <NavLink to='https://github.com/princeraval147/crazy-car' target='_blank'>
                        <svg
                            className='github' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>

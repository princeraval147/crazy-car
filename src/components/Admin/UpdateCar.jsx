      ...
      <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
        <div style={styles.formLeft}>
          <label style={styles.label}>
            ...
            {errors.model && (
              <span style={styles.error}>{errors.model.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.brand && (
              <span style={styles.error}>{errors.brand.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            {errors.price && (
              <span style={styles.error}>{errors.price.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.year && (
              <span style={styles.error}>{errors.year.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            Diesel
            {errors.fuelType && (
              <span style={styles.error}>{errors.fuelType.message}</span>
            )}
          </label>
          <label style={styles.label}>
            Mileage:
            ...
            />
            {errors.mileage && (
              <span style={styles.error}>{errors.mileage.message}</span>
            )}
          </label>
          <label style={styles.label}>
            Transmission:
            ...
            Manual
            {errors.transmission && (
              <span style={styles.error}>{errors.transmission.message}</span>
            )}
          </label>
          <label style={styles.label}>
            Engine Capacity (cc):
            ...
            {errors.engineCapacity && (
              <span style={styles.error}>{errors.engineCapacity.message}</span>
            )}
          </label>
        </div>
        ...
        <div style={styles.formRight}>
          <label style={styles.label}>
            ...
            {errors.seatingCapacity && (
              <span style={styles.error}>{errors.seatingCapacity.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.bodyType && (
              <span style={styles.error}>{errors.bodyType.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.bootSpace && (
              <span style={styles.error}>{errors.bootSpace.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            {errors.safetyFeatures && (
              <span style={styles.error}>{errors.safetyFeatures.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.features && (
              <span style={styles.error}>{errors.features.message}</span>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            />
            {errors.warranty && (
              <span style={styles.error}>{errors.warranty.message}</span>
            )}
          </label>
